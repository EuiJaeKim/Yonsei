...
typedef uint16_t OutletM$Read_Voltage$val_t;
typedef uint16_t OutletM$Read_Humi$val_t;
typedef TMilli OutletM$RelayTimer$precision_tag;
typedef uint16_t OutletM$Read_Ultrared$val_t;
typedef uint16_t OutletM$Read_Photo$val_t;
typedef uint16_t OutletM$Read_Temp$val_t;
typedef TMilli OutletM$Timer$precision_tag;
...
typedef uint16_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$val_t;
typedef uint16_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$val_t;
...
enum /*OutletC.SensirionSht11C*/SensirionSht11C$0$__nesc_unnamed4323 {
  SensirionSht11C$0$TEMP_KEY = 0U
};
enum /*OutletC.SensirionSht11C*/SensirionSht11C$0$__nesc_unnamed4324 {
  SensirionSht11C$0$HUM_KEY = 1U
};
typedef uint16_t /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$val_t;
typedef uint16_t /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$val_t;
...
enum /*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$__nesc_unnamed4325 {
  AdcReadClientC$0$ID = 0U, AdcReadClientC$0$HAL_ID = 0U
};
typedef uint16_t /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$val_t;
typedef uint16_t /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$val_t;
enum /*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$__nesc_unnamed4326 {
  AdcReadClientC$1$ID = 1U, AdcReadClientC$1$HAL_ID = 1U
};
typedef uint16_t /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$val_t;
typedef uint16_t /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$val_t;
enum /*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$__nesc_unnamed4327 {
...
static  void OutletM$Boot$booted(void);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void OutletM$Read_Voltage$readDone(error_t arg_0x7ee20010, OutletM$Read_Voltage$val_t arg_0x7ee20198);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void OutletM$AMSend$sendDone(message_t *arg_0x7ed74030, error_t arg_0x7ed741b8);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void OutletM$SendSensorData$runTask(void);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void OutletM$Read_Humi$readDone(error_t arg_0x7ee20010, OutletM$Read_Humi$val_t arg_0x7ee20198);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void OutletM$RelayTimer$fired(void);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void OutletM$Read_Ultrared$readDone(error_t arg_0x7ee20010, OutletM$Read_Ultrared$val_t arg_0x7ee20198);
#line 63
static  void OutletM$Read_Photo$readDone(error_t arg_0x7ee20010, OutletM$Read_Photo$val_t arg_0x7ee20198);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t *OutletM$Receive$receive(message_t *arg_0x7ed71e10, void *arg_0x7ed70010, uint8_t arg_0x7ed70198);
# 88 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static  void OutletM$CommControl$startDone(error_t arg_0x7ee01578);
#line 110
static  void OutletM$CommControl$stopDone(error_t arg_0x7ee000f8);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void OutletM$Read_Temp$readDone(error_t arg_0x7ee20010, OutletM$Read_Temp$val_t arg_0x7ee20198);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void OutletM$Timer$fired(void);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidityDone(error_t arg_0x7e7f8b70, uint16_t arg_0x7e7f8d00);
#line 116
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$writeStatusRegDone(error_t arg_0x7e7f53a0);
#line 100
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$readStatusRegDone(error_t arg_0x7e7f6730, uint8_t arg_0x7e7f68b8);
#line 54
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$resetDone(error_t arg_0x7e800820);
#line 69
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureTemperatureDone(error_t arg_0x7e7f80f8, uint16_t arg_0x7e7f8288);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$read(void);
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$granted(void);
# 84 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/sht11/SensirionSht11.nc"
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureHumidityDone(error_t arg_0x7e7f8b70, uint16_t arg_0x7e7f8d00);
#line 116
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$writeStatusRegDone(error_t arg_0x7e7f53a0);
#line 100
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$readStatusRegDone(error_t arg_0x7e7f6730, uint8_t arg_0x7e7f68b8);
#line 54
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$resetDone(error_t arg_0x7e800820);
#line 69
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperatureDone(error_t arg_0x7e7f80f8, uint16_t arg_0x7e7f8288);
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$granted(void);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$read(void);
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$read(void);
...
static  void /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$readDone(error_t arg_0x7ee20010, /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$val_t arg_0x7ee20198);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$read(void);
...
static  void /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$readDone(error_t arg_0x7ee20010, /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$val_t arg_0x7ee20198);
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$read(void);
...
static  void /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$readDone(error_t arg_0x7ee20010, /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$val_t arg_0x7ee20198);
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t arg_0x7ed82c18, message_t *arg_0x7ed82dc8, uint8_t arg_0x7ed81010);
#line 125
static  void */*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(message_t *arg_0x7ed74c68);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *arg_0x7e44e598, error_t arg_0x7e44e720);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t OutletM$Read_Voltage$read(void);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t OutletM$AMSend$send(am_addr_t arg_0x7ed82c18, message_t *arg_0x7ed82dc8, uint8_t arg_0x7ed81010);
#line 125
static  void *OutletM$AMSend$getPayload(message_t *arg_0x7ed74c68);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t OutletM$SendSensorData$postTask(void);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t OutletM$Read_Humi$read(void);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void OutletM$RelayTimer$startOneShot(uint32_t arg_0x7ee62ca8);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t OutletM$Read_Ultrared$read(void);
#line 55
static  error_t OutletM$Read_Photo$read(void);
# 12 "Relay.nc"
static  error_t OutletM$Relay$relay_clear0(void);
static  error_t OutletM$Relay$relay_clear1(void);
#line 10
static  error_t OutletM$Relay$relay_set0(void);
...
static  error_t OutletM$Relay$relay_init(void);
#line 11
static  error_t OutletM$Relay$relay_set1(void);
# 79 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static  error_t OutletM$CommControl$start(void);
# 89 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static   void OutletM$Leds$led2Toggle(void);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t OutletM$Read_Temp$read(void);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void OutletM$Timer$startPeriodic(uint32_t arg_0x7ee626d8);
# 88 "OutletM.nc"
enum OutletM$__nesc_unnamed4336 {
#line 88
  OutletM$SendSensorData = 0U
};
#line 88
typedef int OutletM$__nesc_sillytask_SendSensorData[OutletM$SendSensorData];
#line 22
message_t OutletM$SensorData;
uint16_t OutletM$myTemp;
uint16_t OutletM$myHumi;
uint16_t OutletM$myPhoto;
uint16_t OutletM$myUltrared;
uint16_t OutletM$myBattery;
uint16_t OutletM$Raw_Temp;
uint16_t OutletM$Raw_Humi;

static inline void OutletM$calc_SHT_(uint16_t p_humidity, uint16_t p_temperature);

static void OutletM$RelayChange(uint8_t relay0, uint8_t relay1, uint16_t time);
static inline  void OutletM$Boot$booted(void);
#line 49
static inline  void OutletM$CommControl$startDone(error_t error);

static inline  void OutletM$CommControl$stopDone(error_t error);

static inline  void OutletM$Timer$fired(void);



static inline  void OutletM$Read_Photo$readDone(error_t err, uint16_t val);





static inline  void OutletM$Read_Temp$readDone(error_t err, uint16_t val);





static  void OutletM$Read_Humi$readDone(error_t err, uint16_t val);
...
static inline  void OutletM$Read_Voltage$readDone(error_t err, uint16_t val);





static inline  void OutletM$Read_Ultrared$readDone(error_t err, uint16_t val);




static inline  void OutletM$SendSensorData$runTask(void);
#line 105
static inline  void OutletM$AMSend$sendDone(message_t *msg, error_t error);



static inline  message_t *OutletM$Receive$receive(message_t *msg, void *payload, uint8_t len);
#line 158
static void OutletM$RelayChange(uint8_t relay0, uint8_t relay1, uint16_t time);
#line 170
static inline  void OutletM$RelayTimer$fired(void);
...
static  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidity(void);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$readDone(error_t arg_0x7ee20010, /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$val_t arg_0x7ee20198);
# 101 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$release(void);
#line 78
static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$request(void);
# 61 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/sht11/SensirionSht11.nc"
static  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperature(void);
# 101 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$release(void);
#line 78
static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$request(void);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$readDone(error_t arg_0x7ee20010, /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$val_t arg_0x7ee20198);
# 53 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/sht11/SensirionSht11ReaderP.nc"
static inline  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$read(void);




static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$granted(void);
...
static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperatureDone(error_t result, uint16_t val);




static inline  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$read(void);




static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$granted(void);
...
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidityDone(error_t result, uint16_t val);




static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$resetDone(error_t result);
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureHumidityDone(error_t result, uint16_t val);
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$readStatusRegDone(error_t result, uint8_t val);
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$writeStatusRegDone(error_t result);

static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$resetDone(error_t result);
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureTemperatureDone(error_t result, uint16_t val);
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$readStatusRegDone(error_t result, uint8_t val);
static inline  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$writeStatusRegDone(error_t result);
# 50 "/opt/tinyos-2.x/tos/interfaces/GpioInterrupt.nc"
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$readDone(error_t arg_0x7ee20010, /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$val_t arg_0x7ee20198);
#line 55
static  error_t /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$read(void);
# 33 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/ADC_ShiftM.nc"
static inline  error_t /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$read(void);



static inline  void /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$readDone(error_t result, uint16_t val);
# 110 "/opt/tinyos-2.x/tos/chips/atm128/adc/Atm128AdcMultiple.nc"
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$readDone(error_t arg_0x7ee20010, /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$val_t arg_0x7ee20198);
#line 55
static  error_t /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$read(void);
# 33 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/ADC_ShiftM.nc"
static inline  error_t /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$read(void);



static inline  void /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$readDone(error_t result, uint16_t val);
# 31 "/opt/tinyos-2.x/tos/platforms/homenet/ZigbexBusAdc.nc"
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$readDone(error_t arg_0x7ee20010, /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$val_t arg_0x7ee20198);
#line 55
static  error_t /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$read(void);
# 33 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/ADC_ShiftM.nc"
static inline  error_t /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$read(void);



static inline  void /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$readDone(error_t result, uint16_t val);
# 35 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t *arg_0x7ed74030, error_t arg_0x7ed741b8);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static  error_t /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t *arg_0x7e451468, uint8_t arg_0x7e4515f0);
#line 114
static  void */*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(message_t *arg_0x7e44d1f8);
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t *arg_0x7e471c30, am_addr_t arg_0x7e471dc0);
#line 151
static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t *arg_0x7e46dbe8, am_id_t arg_0x7e46dd70);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline  error_t /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
...
static inline  void */*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(message_t *m);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static   void OutletM$Leds$led2Toggle(void){
#line 89
...
#line 105
{
  OutletM$Leds$led2Toggle();
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t *arg_0x7ed74030, error_t arg_0x7ed741b8){
#line 99
  OutletM$AMSend$sendDone(arg_0x7ed74030, arg_0x7ed741b8);
#line 99
}
#line 99
...
#line 57
{
  /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
#line 89
    case 0U:
#line 89
      /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(arg_0x7e44e598, arg_0x7e44e720);
#line 89
      break;
#line 89
    default:
...
#line 67
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static   error_t OutletM$SendSensorData$postTask(void){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(OutletM$SendSensorData);
#line 56
  ...
  switch (pUH->cmd) {
      case COMM_GET: 
        if (pUH->sub == COMM_GET_ALL) {
            OutletM$SendSensorData$postTask();
          }
      break;
      case COMM_SET: 
        Relay_time = 0xffff;
...
#line 125
      ...
      if (pUH->sub == COMM_SET_RELAY_1D) {
          OutletM$RelayChange(2, 0, Relay_time);
        }
      else {
#line 130
        if (pUH->sub == COMM_SET_RELAY_1C) {
            OutletM$RelayChange(2, 1, Relay_time);
          }
        else {
#line 133
          if (pUH->sub == COMM_SET_RELAY_0D) {
              OutletM$RelayChange(0, 2, Relay_time);
            }
          else {
#line 136
            if (pUH->sub == COMM_SET_RELAY_0C) {
                OutletM$RelayChange(1, 2, Relay_time);
              }
            else {
#line 139
              if (pUH->sub == COMM_SET_RELAY_1D0D) {
                  OutletM$RelayChange(0, 0, Relay_time);
                }
              else {
#line 142
                if (pUH->sub == COMM_SET_RELAY_1D0C) {
                    OutletM$RelayChange(1, 0, Relay_time);
                  }
                else {
#line 145
                  if (pUH->sub == COMM_SET_RELAY_1C0D) {
                      OutletM$RelayChange(0, 1, Relay_time);
                    }
                  else {
#line 148
                    if (pUH->sub == COMM_SET_RELAY_1C0C) {
                        OutletM$RelayChange(1, 1, Relay_time);
                      }
                    }
                  }
                }
...
#line 67
    case 9:
#line 67
      result = OutletM$Receive$receive(arg_0x7ed71e10, arg_0x7ed70010, arg_0x7ed70198);
#line 67
      break;
#line 67
    default:
...
# 11 "Relay.nc"
inline static  error_t OutletM$Relay$relay_set1(void){
#line 11
  unsigned char result;
#line 11
...
# 10 "Relay.nc"
inline static  error_t OutletM$Relay$relay_set0(void){
#line 10
  unsigned char result;
#line 10
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static  void OutletM$RelayTimer$startOneShot(uint32_t arg_0x7ee62ca8){
#line 62
...
#line 110
  OutletM$CommControl$stopDone(arg_0x7ee000f8);
#line 110
}
#line 110
...
#line 88
  OutletM$CommControl$startDone(arg_0x7ee01578);
#line 88
}
#line 88
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$request(void){
#line 78
  unsigned char result;
#line 78

#line 78
  result = /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Resource$request(/*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY);
#line 78
...
#line 53
{
  /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$request();
  return SUCCESS;
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t OutletM$Read_Temp$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$read();
#line 55
...
#line 60
  OutletM$Read_Temp$read();
}

# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  void /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$readDone(error_t arg_0x7ee20010, /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$val_t arg_0x7ee20198){
#line 63
  OutletM$Read_Photo$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
}
#line 63
...
#line 37
{
  /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$readDone(result, val >> 6);
}
...
{
  if (err == SUCCESS) {
    OutletM$myUltrared = val;
    }
}

# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  void /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$readDone(error_t arg_0x7ee20010, /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$val_t arg_0x7ee20198){
#line 63
  OutletM$Read_Ultrared$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
}
#line 63
# 37 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/ADC_ShiftM.nc"
...
#line 37
{
  /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$readDone(result, val >> 6);
}
...
#line 78
    case /*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$ID:
#line 78
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$request(/*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$HAL_ID);
#line 78
      break;
#line 78
    case /*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$ID:
#line 78
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$request(/*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$HAL_ID);
#line 78
      break;
#line 78
    case /*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$ID:
#line 78
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$request(/*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$HAL_ID);
#line 78
      break;
#line 78
    default:
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$read(/*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$ID);
#line 55
...
#line 33
{
  return /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$read();
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t OutletM$Read_Ultrared$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$Read$read();
#line 55
...
{
  if (err == SUCCESS) {
    OutletM$myBattery = val;
    }
#line 80
  OutletM$Read_Ultrared$read();
}

# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  void /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$readDone(error_t arg_0x7ee20010, /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$val_t arg_0x7ee20198){
#line 63
  OutletM$Read_Voltage$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
}
#line 63
# 37 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/ADC_ShiftM.nc"
...
#line 37
{
  /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$readDone(result, val >> 6);
}
...
#line 63
    case /*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$ID:
#line 63
      /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
      break;
#line 63
    case /*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$ID:
#line 63
      /*OutletC.UltraredSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$1$subRead$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
      break;
#line 63
    case /*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$ID:
#line 63
      /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
      break;
#line 63
    default:
...
#line 101
    case /*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$ID:
#line 101
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$release(/*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$HAL_ID);
#line 101
      break;
#line 101
    case /*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$ID:
#line 101
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$release(/*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$HAL_ID);
#line 101
      break;
#line 101
    case /*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$ID:
#line 101
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$release(/*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$HAL_ID);
#line 101
      break;
#line 101
    default:
...
#line 55
    case /*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$HAL_ID:
#line 55
      PhotoP$ResourceConfigure$unconfigure();
#line 55
      break;
#line 55
    case /*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$HAL_ID:
#line 55
      UltraredP$ResourceConfigure$unconfigure();
#line 55
      break;
#line 55
    case /*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$HAL_ID:
#line 55
...
#line 92
    case /*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$HAL_ID:
#line 92
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$granted(/*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$ID);
#line 92
      break;
#line 92
    case /*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$HAL_ID:
#line 92
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$granted(/*OutletC.UltraredSensorC.DemoChannel.UltraredProC.AdcReadClientC*/AdcReadClientC$1$ID);
#line 92
      break;
#line 92
    case /*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$HAL_ID:
#line 92
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$granted(/*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$ID);
#line 92
      break;
#line 92
    default:
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$request(void){
#line 78
  unsigned char result;
#line 78

#line 78
  result = /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Resource$request(/*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY);
#line 78
...
#line 71
{
  /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$request();
  return SUCCESS;
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t OutletM$Read_Humi$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$read();
#line 55
...
{
  if (err == SUCCESS) {
    OutletM$Raw_Temp = val;
    }
#line 66
  OutletM$Read_Humi$read();
}

# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$readDone(error_t arg_0x7ee20010, /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$val_t arg_0x7ee20198){
#line 63
  OutletM$Read_Temp$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
}
#line 63
# 101 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$release(void){
#line 101
  unsigned char result;
#line 101

#line 101
  result = /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Resource$release(/*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY);
#line 101
...
# 61 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/sht11/SensirionSht11.nc"
inline static  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperature(void){
#line 61
  unsigned char result;
#line 61

#line 61
  result = /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$measureTemperature(/*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY);
#line 61
...
#line 60
  if ((result = /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperature()) != SUCCESS) {
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$release();
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$readDone(result, 0);
    }
}

# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  void /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$readDone(error_t arg_0x7ee20010, /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$val_t arg_0x7ee20198){
#line 63
  OutletM$Read_Humi$readDone(arg_0x7ee20010, arg_0x7ee20198);
#line 63
}
#line 63
# 101 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static   error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$release(void){
#line 101
  unsigned char result;
#line 101

#line 101
  result = /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Resource$release(/*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY);
#line 101
...
# 76 "/opt/tinyos-2.x/tos/sensorboards/homenet_sensor/sht11/SensirionSht11.nc"
inline static  error_t /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidity(void){
#line 76
  unsigned char result;
#line 76

#line 76
  result = /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$measureHumidity(/*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY);
#line 76
...
#line 78
  if ((result = /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidity()) != SUCCESS) {
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$release();
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$readDone(result, 0);
    }
}
...
#line 92
  switch (arg_0x7e6845d0) {
#line 92
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 92
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$granted();
#line 92
      break;
#line 92
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 92
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$granted();
#line 92
      break;
#line 92
    default:
...
#line 192
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 192
    OutletM$myTemp = (uint16_t )t_C;
#line 192
    __nesc_atomic_end(__nesc_atomic); }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 193
    OutletM$myHumi = (uint16_t )rh_true;
#line 193
    __nesc_atomic_end(__nesc_atomic); }
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$read(/*OutletC.VoltageC.VoltageProC.AdcReadClientC*/AdcReadClientC$2$ID);
#line 55
...
#line 33
{
  return /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$subRead$read();
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t OutletM$Read_Voltage$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*OutletC.VoltageC.ADC_ShiftM*/ADC_ShiftM$2$Read$read();
#line 55
...
{
  /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$HumResource$release();
  /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$readDone(result, val);
}
...
#line 84
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 84
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureHumidityDone(arg_0x7e7f8b70, arg_0x7e7f8d00);
#line 84
      break;
#line 84
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 84
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidityDone(arg_0x7e7f8b70, arg_0x7e7f8d00);
#line 84
      break;
#line 84
    default:
...
#line 69
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 69
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperatureDone(arg_0x7e7f80f8, arg_0x7e7f8288);
#line 69
      break;
#line 69
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 69
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureTemperatureDone(arg_0x7e7f80f8, arg_0x7e7f8288);
#line 69
      break;
#line 69
    default:
...
#line 116
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 116
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$writeStatusRegDone(arg_0x7e7f53a0);
#line 116
      break;
#line 116
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 116
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$writeStatusRegDone(arg_0x7e7f53a0);
#line 116
      break;
#line 116
    default:
...
#line 100
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 100
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$readStatusRegDone(arg_0x7e7f6730, arg_0x7e7f68b8);
#line 100
      break;
#line 100
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 100
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$readStatusRegDone(arg_0x7e7f6730, arg_0x7e7f68b8);
#line 100
      break;
#line 100
    default:
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$read(/*OutletC.PhotoSensorC.DemoChannel.PhotoProC.AdcReadClientC*/AdcReadClientC$0$ID);
#line 55
...
#line 33
{
  return /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$subRead$read();
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  error_t OutletM$Read_Photo$read(void){
#line 55
  unsigned char result;
#line 55

#line 55
  result = /*OutletC.PhotoSensorC.DemoChannel.ADC_ShiftM*/ADC_ShiftM$0$Read$read();
#line 55
...
#line 54
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 54
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$resetDone(arg_0x7e800820);
#line 54
      break;
#line 54
    case /*OutletC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 54
      /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$resetDone(arg_0x7e800820);
#line 54
      break;
#line 54
    default:
...
# 13 "Relay.nc"
inline static  error_t OutletM$Relay$relay_clear1(void){
#line 13
  unsigned char result;
#line 13
...
# 12 "Relay.nc"
inline static  error_t OutletM$Relay$relay_clear0(void){
#line 12
  unsigned char result;
#line 12
...
#line 170
{
  OutletM$Relay$relay_clear0();
  OutletM$Relay$relay_clear1();
}
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static  error_t /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t *arg_0x7e451468, uint8_t arg_0x7e4515f0){
#line 64
  unsigned char result;
#line 64
...
inline static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t *arg_0x7e46dbe8, am_id_t arg_0x7e46dd70){
#line 151
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static  void /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t *arg_0x7e471c30, am_addr_t arg_0x7e471dc0){
#line 92
...
#line 47
{
  /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 9);
  return /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static  error_t OutletM$AMSend$send(am_addr_t arg_0x7ed82c18, message_t *arg_0x7ed82dc8, uint8_t arg_0x7ed81010){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(arg_0x7ed82c18, arg_0x7ed82dc8, arg_0x7ed81010);
#line 69
...
# 114 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static  void */*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(message_t *arg_0x7e44d1f8){
#line 114
  void *result;
#line 114
...
#line 65
{
  return /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(m);
}

# 125 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static  void *OutletM$AMSend$getPayload(message_t *arg_0x7ed74c68){
#line 125
  void *result;
#line 125

#line 125
  result = /*OutletC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(arg_0x7ed74c68);
#line 125
...
#line 90
    {
      ...
      sensorData.photo = OutletM$myPhoto;
      sensorData.temp = OutletM$Raw_Temp;
      sensorData.humi = OutletM$Raw_Humi;
      sensorData.infrared = OutletM$myUltrared;
      sensorData.battery = OutletM$myBattery;
    }
#line 100
    __nesc_atomic_end(__nesc_atomic); }
  memcpy(OutletM$AMSend$getPayload(&OutletM$SensorData), &sensorData, sizeof sensorData);
  OutletM$AMSend$send(AM_BROADCAST_ADDR, &OutletM$SensorData, sizeof sensorData);
}
...
# 79 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static  error_t OutletM$CommControl$start(void){
#line 79
  unsigned char result;
#line 79
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static  void OutletM$Timer$startPeriodic(uint32_t arg_0x7ee626d8){
#line 53
...
# 19 "Relay.nc"
inline static  error_t OutletM$Relay$relay_init(void){
#line 19
  unsigned char result;
#line 19
...
#line 35
    {
      OutletM$myTemp = 0xFFFF;
      OutletM$myHumi = 0xFFFF;
      OutletM$myPhoto = 0xFFFF;
      OutletM$myUltrared = 0xFFFF;
      OutletM$Raw_Temp = 0xFFFF;
      OutletM$Raw_Humi = 0xFFFF;
      OutletM$myBattery = 0xFFFF;
    }
#line 43
    __nesc_atomic_end(__nesc_atomic); }
  OutletM$Relay$relay_init();
  OutletM$Timer$startPeriodic(1000);
  OutletM$CommControl$start();
}
...
#line 64
    case OutletM$SendSensorData:
#line 64
      OutletM$SendSensorData$runTask();
#line 64
      break;
#line 64
...
#line 167
  if (time != 0xFFFF) {
    OutletM$RelayTimer$startOneShot(time);
    }
}
...
#line 69
{
  if (err == SUCCESS && OutletM$Raw_Temp != 0xFFFF) {
      OutletM$Raw_Humi = val;
      OutletM$calc_SHT_(OutletM$Raw_Humi, OutletM$Raw_Temp);
    }
  OutletM$Read_Voltage$read();
}
...
{
  /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$TempResource$release();
  /*OutletC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$readDone(result, val);
}
